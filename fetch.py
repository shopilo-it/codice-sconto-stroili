#!/usr/bin/env python3
"""
Recupero codici sconto Stroili da shopilo.it
Sursa: https://shopilo.it/negozi/stroilioro.com
"""
...
SHOPILO_URL = "https://shopilo.it/negozi/stroilioro.com"
STORE_NAME = "Stroili"


def fetch_coupons(url=SHOPILO_URL):
    """Restituisce la lista dei coupon attivi per Stroili da shopilo.it"""
    headers = {
        "User-Agent": "Mozilla/5.0 (compatible; coupon-fetcher/1.0; +https://github.com/shopilo-it/codice-sconto-stroili)"
    }
    try:
